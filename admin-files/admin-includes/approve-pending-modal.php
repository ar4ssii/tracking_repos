<!-- Modal  -->
<div class="modal fade text-start" id="ApprovePendingModal_<?= $row['deliverID'] ?>" tabindex="-1" aria-labelledby="ApprovePendingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ApprovePendingModalLabel">Confirm Approval of Pending Booking</h5>
            </div>
            <div class="modal-body ">
                <h5>Are you sure to approve <?= $row['transactionNumber'] ?>?</h5>
                <div class="col">
                    <h6>Details</h6>
                ...
                <form action="../config/approve_pending_ctrl.php" method="post">
                    <div class="row my-3">
                        <div class="col">
                    ...
                    <div class="col text-center">
                        <button class="btn btn-info rounded-pill text-white" name="btn_approve_pending" type="submit">Yes</button>
